        ...
        <>
            <section className="relative overflow-x-hidden">
                ...
                <div className=" bg-testbg rounded-3xl bg-cover bg-center pt-14 pb-8">
                    <div className="lg:p-8 p-4 mx-auto space-y-12 max-w-screen-xl">
                        <div className="flex flex-col items-center space-y-4">
                            <span className = "text-center text-xl lg:text-5xl text-main-color/80 capitalize">what we offer?</span>
                            <div className=" text-center flex flex-col">
                                <span className = "text-3xl lg:text-xl text-white">
                ...
                <div className=" bg-test2 bg-center bg-cover pt-14 pb-4">
                    <div className="lg:p-8 p-4 mx-auto space-y-12 max-w-screen-2xl">
                        <div className="flex flex-col items-center space-y-4">
                            <span className = "text-center text-xl lg:text-5xl text-main-color/80 capitalize">Our Website Demos</span>
                            <div className=" text-center flex flex-col">
                                <span className = "text-3xl lg:text-xl text-white">
